	...
	return (
		<div className = "h-full bg-primary flex flex-col py-32"> 
			...
			<div className = "grow py-10 flex flex-col justify-end">
				<h5 className = "w-full text-center text-primary100 font-semibold text-lg">crafted by</h5>
				<h6 className = "w-full text-center text-white font-semibold text-2xl">Vansh and Nick</h6>
			</div>
		</div>
	)
